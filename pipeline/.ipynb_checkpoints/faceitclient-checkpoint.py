...
from configs.exceptions import SkippingMatch, SoftRateLimit
...
class FaceitClient():
    ...
    def lifetime_aggregates(self, player_id):
        ...
        try:
            ...
            lifetime_url = "https://open.faceit.com/data/v4/players/{player_id}/stats/{game_id}"
            resp = r.get(
                url = lifetime_url,
                header = self.headers
            )
